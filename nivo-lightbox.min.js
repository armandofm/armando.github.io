	...
	o.prototype = {
		...
		showLightbox : function() {
			...
			if (this.$el.attr("data-lightbox-gallery")) {
				var t = this, s = e('[data-lightbox-gallery="'
		...
		processContent : function(n, r) {
			...
			if (s.match(/\.(jpeg|jpg|gif|png)$/) != null) {
				...
				o.error(function() {
					...
					.match(/(youtube|youtu|vimeo)\.(com|be)\/(watch\?v=(\w+)|(\w+))/)) {
				...
				if (e(s).length) {
					...
					var l = e('<div class="nivo-lightbox-error"><p>'
							+ i.options.errorMessage + "</p></div>");
					n.html(l).removeClass("nivo-lightbox-loading")
				}
			} else {
		...
		constructLightbox : function() {
			...
			var t = e("<div>", {
				"class" : "nivo-lightbox-overlay nivo-lightbox-theme-"
						+ this.options.theme + " nivo-lightbox-effect-"
						+ this.options.effect
			});
			var n = e("<div>", {
		...
		destructLightbox : function() {
			...
			e("body").removeClass(
					"nivo-lightbox-body-effect-" + t.options.effect);
			var n = 0;
			if (n) {
